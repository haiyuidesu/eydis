...
extern "C"
{
    ...
    static char *bitwise_mnemonics_logical_32[16] = {
        "and", "bic", "orr", "orn", "eor", NULL, "pkh", NULL,
    ...
    static char *load_atomics_mnemonics[64] = {
        ...
        "ldclr", "ldclrl", "ldclra", "ldclral", "ldeorb", "ldeorlb", "ldeorab", "ldeoralb",
        "ldeorh", "ldeorlh", "ldeorah", "ldeoralh", "ldeor", "ldeorl", "ldeora", "ldeoral",
        "ldeor", "ldeorl", "ldeora", "ldeoral", "ldsetb", "ldsetlb", "ldsetab", "ldsetalb",
        "ldseth", "ldsetlh", "ldsetah", "ldsetalh", "ldset", "ldsetl", "ldseta", "ldsetal",
        "ldset", "ldsetl", "ldseta", "ldsetal"
    };

    static char *atomics_swap_mnemonics[16] = {
        "swpb", "swplb", "swpab", "swpalb", "swph", "swplh", "swpah", "swpalh",
        "swp", "swpl", "swpa", "swpal", "swp", "swpl", "swpa", "swpal"
    };
